...
QT_MOC_LITERAL(1, 13, 9), // "imageMain"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 5), // "image"
QT_MOC_LITERAL(4, 30, 11) // "imageResult"

    },
    "CameraThread\0imageMain\0\0image\0imageResult"
};
...
void CameraThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->imageMain((*reinterpret_cast< const QImage(*)>(_a[1]))); break;
        case 1: _t->imageResult((*reinterpret_cast< const QImage(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CameraThread::imageMain)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (CameraThread::*)(const QImage & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CameraThread::imageResult)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void CameraThread::imageMain(const QImage & _t1)
{
...
// SIGNAL 1
void CameraThread::imageResult(const QImage & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
